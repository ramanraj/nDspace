...
<h3>Kaprekar's Constant 6174 for four digit numbers and
 Constants 97508421 and 63317664 for eight digit numbers</h3> 
<p>- Ramanraj K</p>
<p><i>24<sup>th</sup> August, 2020</i></p> 
<h4>Introduction:</h4> 
...
$frm = "
<form method=post action=6174.php>
...
for ($i=0; $i <$max_steps; $i++){
  ...
  // echo "<p>pad: $kap</p><br>";
    ...
    if ($kaplen == 4){
       if ($kap == $kap4){
          echo "<h3>Reached in $ctr steps</h3>";
          break;
       }
    } elseif ($kaplen == 8){
       if ($kap == $kap8){
          echo "<h3>Reached $kap8 in $ctr steps</h3>";
          break; 
        } elseif ($kap == $kap8_2){
          echo "<h3>Reached $kap8_2 in $ctr steps</h3>";
          break;      
        } elseif ($kap == $kapstart){
          // if this does happen
          echo "<h3>Reached $kapstart in $ctr steps</h3>";
          break;
        }
    }
}
